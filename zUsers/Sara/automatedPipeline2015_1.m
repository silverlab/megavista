...
% Edited basic variables for my specific paths, etc.
% Also added a step to re-run motion correction on the mcf files to make
% sure that this has actually corrected all motion and parameters are at or
% near 0 at all times.
% ------------------------------------------------------------------------------------------------------------
clc
% ------------------------------------------------------------------------------------------------------------
...
disp(['***********       STARTING PIPELINE for subjectID ', subjectID,'       *******************'])
...
disp(['***********       PIPELINE FINISHED for subjectID ', subjectID,'       *******************'])
