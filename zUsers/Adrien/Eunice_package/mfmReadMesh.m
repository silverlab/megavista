...
disp('mfmReadMesh: edited to avoid errors - Eunice Yang, Rachel Denison.')
...
%     EY: error message says "too many output arguments"; fileparts
%     generates error with matlab 2012a and beyond
    [origPath, origName, origExt] = fileparts(meshFileName);
