function fs_ribbon2itk_noRAS(subjID, outfile, fillWithCSF, alignTo, resample_type, in_orientation)
...
%  If it is a full path begining with a / 
%  then we assume it is a full path to the file  
elseif strcmp('/',subjID(1))
    ribbon = subjID;
end
...
disp('Careful: Modified version (Chopin 2015) of fs_ribbon2itk.m, that do not force output orientation to RAS orientation') 
