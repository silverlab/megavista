...
set(vw.ui.annotationHandle,'string',annotation(vw,viewGet(vw, 'curScan')));
    ...
    %AC 2015 - this seems incorrect and gives an error so I edited
    disp('refreshMontageView was edited line 66 to avoid annotation handle error - Adrien Chopin, 2015.')
end
% Draw colorbar
