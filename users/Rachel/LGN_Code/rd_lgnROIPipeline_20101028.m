% rd_lgnROIPipeline_20101028 (OLD)
%
...
if exist(filename, 'file')
    ...
    save(filename, ...
        'lgnROI1', 'lgnROI1Coords', 'voxelSets1', 'voxelFFT1', 'meanFFT1', 'data1', 'lgnROI1Mean', ...
        'lgnROI2', 'lgnROI2Coords', 'voxelSets2', 'voxelFFT2', 'meanFFT2', 'data2', 'lgnROI2Mean')
end
