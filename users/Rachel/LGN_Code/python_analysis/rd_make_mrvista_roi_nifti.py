...
def main():
    ...
    # scanner = sys.argv[1]
    # subject = sys.argv[2]
    rois = ['LLGN_ecc0','LLGN_ecc14','LLGN_polar5',
    ...
    data_dir = '/Volumes/Plata1/motion_prf/subjects/JN_08092012_7T/'
    nifti_dir = os.path.join(data_dir,'JN_08092012_7T_nifti/')
    ...
    #constants
    up_samp = [1.1636,1.1636,1.0000] #upsample factor from EPI to GEM
    # up_samp = [2.5606,2.5606,1.0000]
    #usually epi: 2.220 x 2.220 x 2.300; gem: 0.867x0.867x2.300

    example_epi = nifti_dir + 'epi01_motion_mcf.nii.gz'
    ...
    for roi in rois:
        ...
        roi_coords = tsv.upsample_coords(tsv.getROIcoords(roi_file),up_samp)-1
        ...
        fout_nii = out_dir + roi + '_orig.nii.gz'
        ...
        print 'Flipping ROI'
        fout_nii_new = out_dir +  roi + '.nii.gz'
