...
seed_cor_all = np.zeros((8,8,6))
target_cor_all = np.zeros((8,8,6))
cor_all = np.zeros((8,8,6))
coh_all = np.zeros((8,8,6))
...
pickle.dump(ecc_polar_roi_all, open(out_dir + 'ecc_polar_roi_all.pkl','wb'))
...
# figures
fig_seed_cor = viz.drawmatrix_channels(seed_cor_std, seed_rois, color_anchor=0)
fig_target_cor = viz.drawmatrix_channels(target_cor_std, target_rois, color_anchor=0)

visualize.display_matrix(cor_std, 
    xlabels=target_rois, ylabels=seed_rois, cmap=plt.cm.RdBu_r,color_anchor=0)
fig_cor = plt.gcf()

visualize.display_matrix(coh_std, 
    xlabels=target_rois, ylabels=seed_rois, cmap=plt.cm.RdBu_r, color_anchor=0)
fig_coh = plt.gcf()

fig_seed_cor.savefig(out_dir + 'figures/LGN-LGN_cor_mean.png')
fig_target_cor.savefig(out_dir + 'figures/V1-V1_cor_mean.png')
fig_cor.savefig(out_dir + 'figures/LGN-V1_cor_mean.png')
fig_coh.savefig(out_dir + 'figures/LGN-V1_coh_mean.png')

fig_seed_cor.savefig(out_dir + 'figures/LGN-LGN_cor_std.png')
fig_target_cor.savefig(out_dir + 'figures/V1-V1_cor_std.png')
fig_cor.savefig(out_dir + 'figures/LGN-V1_cor_std.png')
fig_coh.savefig(out_dir + 'figures/LGN-V1_coh_std.png')
