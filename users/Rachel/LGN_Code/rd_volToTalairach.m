function [vtTransRotScale vtTransRot] = rd_volToTalairach(volCoords, v2t)
...
% 
% Modified from volToTalairach (mrVista)
%   Now returns the fully transformed coordinates (vtTransRotScale) and
%   coordinates with only translation and rotation transformations applied
%   (vtTransRot). vtTransRotScale = Talairach coordinates.
% Rachel Denison
% 2013 Feb 21
