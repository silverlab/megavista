function [filt_signal]=ecogBandPass(input, sampling_rate, lower_bound, upper_bound, tm_OR_fr)
%  [filt_signal]=band_pass(input, sampling_rate, lower_bound, upper_bound, tm_OR_fr)
