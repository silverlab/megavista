...
blockpath = '/Volumes/witthoft/biac3/wandell7/data/ECoG/ecog03/ecog/MTloc/st06_30';
behpath = '/Volumes/witthoft/biac3/wandell7/data/ECoG/ecog03/ecog/MTloc/behavioral'; % Behavioral data dir (where event files are)
addpath(behpath);
...
prestimdur = 4; %0.1; % 0.1 seconds
epochmax = 4; %5.0;  % 3 seconds
