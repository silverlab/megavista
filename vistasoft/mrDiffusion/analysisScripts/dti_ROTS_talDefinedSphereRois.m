...
for(ii=1:length(f))
    ...
    roiName = {'ROTS'}; %curly brackets are good for lists of strings ROI name list
    talCoords = [42,-57,-6];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ADDING THIS SO IT WILL ALSO DO YEAR 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% AFTERWARDS: MATLAB errors with load dt6 if I try to do both
