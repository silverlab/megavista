...
%  function ctrParams = ctrInitBatchParams([varargin])
% 
%  This function is used to initialize the parameters structure used with
%  ctrInitBatch in doing multi-subject contrack
%  tractography. 
% 
%  * Note: If you do not set 'ctrParams.baseDir', 'ctrParams.dtDir' and
%          'ctrParams.roi1' the call to ctrInitBatch will
%          fail. See 'EXAMPLE USAGE' BELOW.
% 
% VARIABLES:
%    ctrParams ...
