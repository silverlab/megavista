...
ssDir = fullfile(batchDir, 'dti_adults','ctr_controls','shellScripts');
dtiYr = {'dti_adults'};
...
while(isnumeric(shName))
    ...
    [shName, p] = uigetfile({'*.sh';'*.*'}, 'Choose .sh File from example subject...','/biac3/wandell4/data/reading_longitude/dti_adults/aab050307/dti06/fibers/conTrack'); 
end
