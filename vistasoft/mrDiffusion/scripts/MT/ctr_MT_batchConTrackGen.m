...
projectName = 'MTproject_100k_200_5';
% hem = 'LEFT';
 hem = 'RIGHT';
% hem = '';
...
ssDir = fullfile(batchDir,'MT_Project', 'shellScripts','gen');
...
%subs = {'mh0','mho0','mm0','nf0','pt0','rh0','rs0','sg0',...
...
if theChoice == 'y'
    [f, p] = uigetfile({'*.txt';'*.*'}, 'Choose Log File...', '/biac3/wandell4/data/reading_longitude/MT_Project/logs');
    if(isnumeric(f))
