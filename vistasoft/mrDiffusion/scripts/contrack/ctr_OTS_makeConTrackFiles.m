...
logDir = fullfile(baseDir, 'dti_adults','OTS_Broca','logs');
dtiYr = {'dti_adults'};
dtDir = 'dti06';
subs = {'aab0'};

ROI1 = {'VinckierOTS1','VinckierOTS2','VinckierOTS3','VinckierOTS4','VinckierOTS5','VinckierOTS6'};    
ROI2 = {'VinckierBrocaMes+Lat'};
...
c = (c+1); % Counter
        ...
        if ~isempty(sub) % If there is no data for dtiYr{kk}, skip.
            ...
            dt6 = fullfile(dt6Dir,'average_dt6.mat'); % Full path to dt6.mat
