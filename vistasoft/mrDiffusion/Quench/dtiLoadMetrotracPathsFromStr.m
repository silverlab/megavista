...
%
%   fg = dtiLoadMetrotracPathsFromStr(str,xform)
%
% HISTORY:
% 2009.05.06 Adapted from dtiLoadMetrotracPaths to support loading from
% string
%
% Stanford VISTA

% TODO:  This code is both unclear and slow.  We should figure out a  mex
% way to read or at least clarify this code and see if we can do better.
% To re-write it, we have to carefully test because the coordinate
% transforms and offsets by one in the code below are so confusing.  ALl
% the helpful comments will come into play. Sigh.
