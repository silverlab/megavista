function ni = dtiWriteNiftiWrapper(imArray, matrixTransform, filename, sclSlope, description, intentName, intentCode, freqPhaseSliceDim, sliceCodeStartEndDuration, TR)
%
