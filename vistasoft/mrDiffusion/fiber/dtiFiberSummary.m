...
% to the output. Also, the ADC units (for MD, RD and AD) are now um^2/msec
% (assuming that the raw data units are um^2/sec). Finally, we now use
% nearest-neighbor intepolation, which is better than trilinear for this
% purpose. 
%
% TODO
...
% If not supplied, get the fg from the user
if notDefined('whichFG'), whichFG = dtiGet(handles,'currentfibergroupnumber'); end
...
% Create the dt6 data in real units
