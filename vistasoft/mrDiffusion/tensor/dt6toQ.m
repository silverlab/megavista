...
%
% The returned Q is a cell array of quadratic forms.
%
% Example:
%  dt6Data = dt6.dt6;
...
%  eigs(M)
%
% See also: dti6to33 and dti33to6.  
%    These manage the large data volume.
%    This version doesn't apply to the large data set, with many subjects.
%    It is easier for me to understand (BW).  See also dt6VECtoMAT, which
%    takes a single vector format of the tensor and converts it to the
%    proper 3x3 Quadratic form.
%
