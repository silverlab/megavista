function [coords, outMat, imScale] = mrAnatXformCoords(xform, coords, transposeOutput)
%
% [xformedCoords, outMat, imScale] = mrAnatXformCoords(xform, coords, [transposeOutput=true])
%
% Transforms a list of coords given the transform 'xform'. Coords should be
% an 3xN array, although a Nx3 will work, as long as it is not ambiguous
% (ie. 3x3). Returns an Nx3 array of transformed coords.
%
% eg:
...
if(~exist('transposeOutput','var')||isempty(transposeOutput)) 
