function snc = vol2talairachVolume(view,skipTalFlag)
...
%
%    snc = vol2talairachVolume(view,[skipTalFlag = 0])
%
...
if(~isempty(spatialNorm))
    ...
    [junk,tName] = fileparts(spatialNorm.sn.VG.fname); %#ok<NASGU>
