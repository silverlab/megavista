function [co, amp, ph] = computeCorAnalSeries(view, scanNum, sliceNum, nCycles, framesToUse)
%
% [co, amp, ph] = computeCorAnalSeries(view, scanNum, sliceNum, nCycles, framesToUse)
% 
...
% filter.
%
noiseBand = GetNoiseBand(view, scanNum);
