function M = rmPlotGUI(view, roi, allTimePoints, preserveCoords)
% rmPlotGUI - create a GUI for visualizing the results of the retinotopic
% model applied to individual voxels.
%
%    M = rmPlotGUI(view, [roi=selected ROI], [allTimePoints=1(yes)], [preserveCoords=0]);
%
% INPUTS:
%	view: mrVista view. Needs to have a retinotopy model loaded.
%
