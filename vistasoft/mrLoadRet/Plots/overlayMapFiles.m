...
% 
% Prompts for two files containing param maps,
% and puts up a plot with the two superimposed
% over tha view's anatomy image (with sliders
% for things like threshold, colormap).
%
%
% 06/04 ras: wrote it.
