function view = newROI(view,name,select,color,coords, comments)
%
% view = newROI(view,[name],[select],[color],[coords], [comments])
%
...
% 
if ieNotDefined('name'), name=sprintf('ROI%.0f',(size(view.ROIs,2)+1)); end
