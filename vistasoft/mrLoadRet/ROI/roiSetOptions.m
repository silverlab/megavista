...
if ui.filledPerimeter ~= view.ui.filledPerimeter
    view = roiToggleFilledPerimeter(view);
end
...
view.ui = ui; 
if opts.showRois==4, view = roiSelectDisplay(view); end

% let's go ahead and save the viewing preferences
% as well
try, savePrefs(view); end
